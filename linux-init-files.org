...
** ~/bin/x-lock-utils
   ...
   #+begin_src bash :tangle ./directories/bin/x-lock-utils
     #!/usr/bin/bash
     # Maintained in linux-init-files.org
...
*** TODO [#B] look into only time suspend if on battery
    ...
    :END:
*** ~/bin/x-idlehook
    #+begin_src bash :tangle ./directories/bin/x-idlehook
      #!/usr/bin/bash
      # Maintained in linux-init-files.org
...
** ~/bin/rnv
   ...
   #+begin_src bash :tangle ./directories/bin/rnv
     #!/usr/bin/bash
     # Maintained in linux-init-files.org
...
** ~/bin/display-id
   ...
   #+begin_src bash :tangle ./directories/bin/display-id
     #!/usr/bin/bash
     # Maintained in linux-init-files.org
...
** ~/bin/x-backlight-persist
   ...
   #+begin_src bash :tangle ./directories/bin/x-backlight-persist
     #!/usr/bin/bash
     # Maintained in linux-init-files.org
...
*** code
    #+begin_src bash :tangle ./directories/bin/xmg-dual-screens
      #!/usr/bin/bash
      # Maintained in linux-init-files.org
...
* Path
**  ~/bin/add-user-paths
   #+begin_src bash  :tangle ./directories/bin/add-user-paths
     # Maintained in linux-init-files.org
...
** ~/bin/i3pulse
   #+begin_src bash :tangle ./directories/bin/i3pulse
     #!/usr/bin/bash
     # Maintained in linux-init-files.org
...
* Misc utils
** ~/bin/acpi-
   #+begin_src bash :tangle ./directories/bin/edit
     #!/usr/bin/bash
     # Maintained in linux-init-files.org
     emacs-same-frame "$@"
   #+end_src
...
** ~/bin/eman
   ...
   #+begin_src bash :tangle ./directories/bin/eman
     #!/usr/bin/bash
     # Maintained in linux-init-files.org
     mp=${1:-"man"}
   ...
   #+end_src
** ~/bin/expert-advice
   #+begin_src bash :tangle ./directories/bin/expert-advice
     #!/usr/bin/bash
     # Maintained in linux-init-files.org
...
** ~/bin/extract-debug-info
   ...
   #+begin_src bash :tangle ./directories/bin/extract-debug-info
     #!/usr/bin/bash
     # Maintained in linux-init-files.org
     scriptdir=`dirname ${0}`
...
** ~/bin/make-compile_commands
   #+begin_src bash :tangle ./directories/bin/make-compile_commands
     #!/usr/bin/bash
     #Maintained in linux-init-files.org
...
** ~/bin/onehtop
   process viewer
   #+begin_src bash :tangle ./directories/bin/onehtop
     #!/bin/bash
     #Maintained in linux-init-files.org
   ...
   #+end_src
** ~/bin/oneterminal
   #+begin_src bash :tangle ./directories/bin/oneterminal
     #!/usr/bin/bash
     #Maintained in linux-init-files.org
   ...
   #+end_src
** ~/bin/pop-window
   #+begin_src bash :tangle ./directories/bin/pop-window
     #!/usr/bin/bash
     #Maintained in linux-init-files.org
     xdotool windowactivate `xdotool search --name "$1"`
   #+end_src
** ~/bin/random-man-page
   #+begin_src bash :tangle ./directories/bin/random-man-page
     #!/usr/bin/bash
     #Maintained in linux-init-files.org
     man $(find /usr/share/man/man1 -type f | sort -R | head -n1)
   #+end_src
** ~/bin/remove-broken-symlinks
   #+begin_src bash :tangle ./directories/bin/remove-broken-symlinks
     #!/usr/bin/bash
     #Maintained in linux-init-files.org
     find -L . -name . -o -type d -prune -o -type l -exec rm {} +
   #+end_src
** ~/bin/remove-conflicted-copies
   #+begin_src bash :tangle ./directories/bin/remove-conflicted-copies
     #!/usr/bin/bash
     #Maintained in linux-init-files.org
     if [ "$1" == "--f" ]; then
...
** ~/bin/resgithub
   ...
   #+begin_src bash :tangle ./directories/bin/resgithub
     #!/bin/bash
     #Maintained in linux-init-files.org
   ...
   #+end_src
** ~/bin/sharemouse
   #+begin_src bash :tangle ./directories/bin/sharemouse
     #!/usr/bin/bash
     #Maintained in linux-init-files.org
...
** ~/bin/sys-logger
   ...
   #+begin_src bash :tangle ./directories/bin/sys-logger
     #!/usr/bin/bash
     # Maintained in linux-init-files.org
...
*** ~/bin/xmg-neo-rgb-kbd-lights
    ...
    #+begin_src bash :tangle ./directories/bin/xmg-neo-rgb-kbd-lights
      #!/usr/bin/bash
      #Maintained in linux-init-files.org
...
*** ~/bin/google-trans
    #+begin_src bash :tangle ./directories/bin/google-trans
      #!/usr/bin/bash
      #Maintained in linux-init-files.org
      src=$1;shift;
      dst=$1;shift;
...
*** ~/bin/google-trans-de-en
    #+begin_src bash :tangle ./directories/bin/google-trans-de-en
      #!/usr/bin/bash
      #Maintained in linux-init-files.org
...
*** ~/bin/google-trans-en-de
    #+begin_src bash :tangle ./directories/bin/google-trans-en-de
      #!/usr/bin/bash
      #Maintained in linux-init-files.org
...
*** ~/bin/cache-gpg
    #+begin_src bash :tangle ./directories/bin/gpg-cache
      #!/usr/bin/bash
      #Maintained in linux-init-files.org
      SERVICE="gpg-agent"
    ...
    #+end_src
*** ~/bin/pre-lock
    #+begin_src bash :tangle ./directories/bin/pre-lock
      #!/usr/bin/bash
      #Maintained in linux-init-files.org
...
**** Sample .pre-lock
     ...
     #+end_src
*** ~/bin/post-lock
    #+begin_src bash :tangle ./directories/bin/post-lock
      #!/usr/bin/bash
      #Maintained in linux-init-files.org
      x-backlight-persist restore
...
**** Sample .post-lock
     ...
     #+end_src
*** ~/bin/pre-blank
    #+begin_src bash :tangle ./directories/bin/pre-blank
      #!/usr/bin/bash
      #Maintained in linux-init-files.org
      [ -f "${HOME}/.pre-blank" ]  && . "${HOME}/.pre-blank"
    #+end_src
*** ~/bin/post-blank
    #+begin_src bash :tangle ./directories/bin/post-blank
      #!/usr/bin/bash
      #Maintained in linux-init-files.org
      x-backlight-persist restore
